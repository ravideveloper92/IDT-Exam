...
import com.example.myapplication.network.AppModule_ProvideContextFactory;
import com.example.myapplication.network.NetworkModule_ProvideStatesAPIServiceFactory;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends BaseApplication_HiltComponents.ActivityC {
    ...
    @Override
    public void injectLandingActivity(LandingActivity arg0) {
    }
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_example_myapplication_viewmodel_StatesVM, StatesVM_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_myapplication_viewmodel_StatesVM = "com.example.myapplication.viewmodel.StatesVM";

      @KeepFieldType
      StatesVM com_example_myapplication_viewmodel_StatesVM2;
    }
  }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    private Provider<StatesVM> statesVMProvider;
    ...
    private Repository repository() {
      return new Repository(singletonCImpl.provideStatesAPIServiceProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam,
        final ViewModelLifecycle viewModelLifecycleParam) {
      this.statesVMProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_example_myapplication_viewmodel_StatesVM, ((Provider) statesVMProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.myapplication.viewmodel.StatesVM 
          return (T) new StatesVM(viewModelCImpl.repository(), singletonCImpl.provideContextProvider.get());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    ...
    private Provider<StatesAPIService> provideStatesAPIServiceProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideStatesAPIServiceProvider = DoubleCheck.provider(new SwitchingProvider<StatesAPIService>(singletonCImpl, 0));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.myapplication.network.StatesAPIService 
          return (T) NetworkModule_ProvideStatesAPIServiceFactory.provideStatesAPIService();
